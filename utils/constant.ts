...
export const LocaleKey = '_ss_mb_locale';
export const ThemeKey = '_ss_mb_theme';
export const DefaultApiCLient = 'default';
export const AppAuthTokenKey = '_ss_mb_01';
export const AppAuthRefeshTokenKey = '_ss_mb_02';
export const AppAuthDataKey = '_ss_mb_03';
export const AppAuthTokenExpireKey = '_ss_mb_04';
export const AppAuthTokenCreatedKey = '_ss_mb_05';
